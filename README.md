...
**Cook a fresh meal** prepares four servings of garden skillet, then the cook carries the dish to a table. Preparing food costs ingredients; eating restores hunger. Click the served dish to **Call everyone to eat**, take a serving or put away leftovers. Each diner uses a separate plate and available chair, with standing eating when seats are unavailable. Fridge leftovers remain selectable until they spoil. Finished meals leave dirty plates that can be carried to a sink and washed. Partial meals and their ownership survive saving, and furniture moves preserve the same food. This first shared-meal flow has one playable recipe.
...
This is an actively developed game, and the 10/10 target remains open. Current scope does not yet include babies/toddlers, birth/adoption, broader parenting systems, death/inheritance, off-household or deceased relatives, step-family labels, stairs/roofs, pets, or the expansive furnishing and occupation catalogs of a commercial life simulation. The latest full-scope independent review remains **7.2/10**. Shared resource handling, homework coaching and readable speech cards remain in place; see `docs/REVIEWS/iteration_11_speech.md`. The school/work integration passed a seven-day household fixture with all eight members attending five due days and no settled waiting overlaps. Lateness and prolonged low needs still occur; see `docs/REVIEWS/iteration_12_responsibilities.md`. The shared-meal integration passed cooking, dining, furniture-edit and named-restart checks; dense household dining and combined multi-day meal/school autonomy remain unverified. Reducing the sun’s shadow softness removes a conspicuous arm/table stipple in a matched still; broader animated shadow quality remains unverified. Recipe, character and catalogue depth are unfinished; see `docs/REVIEWS/iteration_12_meals.md`. The earlier 6.7/10 failure remains documented in `docs/REVIEWS/iteration_09_autonomy.md`. Production character geometry remains v18; the hair study is unpromoted. The game does not yet claim feature parity with The Sims 4.
