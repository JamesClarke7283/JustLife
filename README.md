...
This is an actively developed game, and the 10/10 target remains open. Current scope does not yet include babies/toddlers, birth/adoption, parenting, death/inheritance, off-household or deceased relatives, step-family labels, stairs/roofs, pets, or the expansive furnishing and occupation catalogs of a commercial life simulation. Review reports distinguish implemented, tested and missing behavior. The latest full-scope independent review is **6.7/10**: a seven-day audit found that four of eight Lifelets could starve while waiting indefinitely for the same bed. Fairer waiting and autonomous replanning are being repaired in source, alongside cooperative homework; the current v18 executable still has that known large-household defect. See `docs/REVIEWS/iteration_09_autonomy.md`. The game does not yet claim feature parity with The Sims 4.
