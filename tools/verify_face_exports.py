"""Fail closed on revision23 decoded exports; no geometry repair or tolerance.
...
PINS = {'character.glb': '5282687264bcc2dd616de487fd415398c19d7d9a7f9d4ad55970c88cb70aaaab', 'character_broad.glb': 'f1a05cffb8748dbac0b21614518be2b6ee8478ab5af3d7c85334ecc97b5949e7', 'character_lod.glb': '617144b4ee3226ba997ea27930133fd57d8d020377d1f2a3dfe1fb5c64dd1cdc', 'character_broad_lod.glb': 'd7070220233155d144f84cae5be91863fb1bca6396f1619292ead50ad8cc78c2'} # Qualified adult local eye/lip revision23; rig18/surface2 retained.
...
def verify_all(directory):
    ...
    assert not failures,'Decoded revision23 export drift; retain raw files and inspect: '+', '.join(failures)
    return results
