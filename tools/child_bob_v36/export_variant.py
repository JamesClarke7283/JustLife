...
parser=argparse.ArgumentParser();parser.add_argument('--source',type=Path,required=True);parser.add_argument('--source-sha256',required=True);parser.add_argument('--output-root',type=Path,required=True);parser.add_argument('--variant',choices=['character_child','character_child_broad','character_child_lod','character_child_broad_lod'],required=True)
