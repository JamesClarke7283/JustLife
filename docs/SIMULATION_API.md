...
2. `queue_action(id, target_id = "", target_position = Vector3.ZERO) -> bool` queues one of at most eight actions. IDs include snack, cook, sleep, nap, shower, toilet, relax, watch, read, paint, work, study, job, school, school_day, career_day, homework, help_homework, water, friendly, joke, deep_talk, flirt, argue, ask_partner, commit, break_up. School/work departures use a registered `lot_exit` target; cooperative homework is coordinated by `LifeHousehold`.
