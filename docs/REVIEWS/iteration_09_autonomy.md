...
Midweek save/load preserves the queues, paid progress, positions, family and other consequential state exactly under the existing comparison checks. Starvation resumes unchanged. Funds grow to **ℒ7,978**, excluding inability to afford food as the cause.
