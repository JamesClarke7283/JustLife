...
### Guest meals follow-up · 9 September 2026

Five new browser-exported screenshots from the [Neighbourhood Potluck guide](https://simscommunity.info/2025/12/29/sims-4-neighbourhood-potluck/) are saved in `topics/neighbourhood_potluck_legacy`, with exact source hashes and inspection notes. All five were inspected. They show event selection, participant roles, carried food, social goals and a reward grill. The page is labelled a legacy article; its displayed December 2025 date accompanies December 2023 image paths. This is For Rent expansion evidence with mixed event choices, not base-only or current-rule proof. The stills do not show a completed guest seating or reward-delivery sequence. JustLife's bounded guest-meal implementation is documented in `GUEST_MEALS.md`.

### Official garden composition, 9 September 2026

The browser saved nine new 1280×720 images from [EA's garden guide](https://careers.ea.com/es/games/the-sims/the-sims-4/news/gnomes-guide-to-garden-harmony), dated 17 June 2026. The archive retains the served AVIF bytes, despite the URLs ending in `.png`; same-size PNG decode previews were used to inspect all nine. The local source manifest records hashes, URLs and expansion labels. Tree branches and uneven foliage outlines, planting at several heights, and soil surrounding garden beds provide useful principles for original environment art. These staged samples do not establish a full gardening workflow. The blue handheld tool's action is unclear in its still, so the page's watering alt text was not adopted as visual proof.
...
### Inheritance interface follow-up, 9 September 2026
