...
static func layout(place:String) -> Array:
	...
	match place:
		...
		"priya_home":entries=[["bed",4.4,-2.7,0],["nightstand",5.0,-1.9,90],["bookshelf",-4.9,-3.2,0],["bookshelf",-3.2,-3.2,0],["bookshelf",-1.5,-3.2,0],["sofa",-2.6,2.6,180],["rug",-2.6,1.7,0],["table",-2.6,.6,0],["lamp",-4.6,1.9,0],["fridge",.3,-3.2,0],["stove",1.7,-3.2,0],["sink",2.55,-3.2,0],["dining",.4,1.5,0],["chair",.4,2.5,180],["toilet",4.2,2.5,180],["shower",5.3,2.9,0],["plant",-5.0,3.6,0]]
