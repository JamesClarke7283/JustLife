...
static func layout(place:String) -> Array:
	var entries:Array=[]
	match place:
		"maya_home":entries=[["bed",-3.3,-2.8,0],["nightstand",-4.2,.1,90],["sofa",-.9,1.1,0],["table",-.9,2.6,0],["rug",-.9,1.7,0],["plant",-4.1,3.4,0],["easel",2.55,3.15,180],["fridge",3.9,-3.2,0],["stove",2.55,-3.3,0],["sink",1.1,-3.3,0],["dining",3.2,.4,0],["chair",3.2,1.4,180],["toilet",-1,-1.5,0],["shower",-1.15,-3.7,0],["bookshelf",-4.1,2.1,90],["plant",4.1,3.3,0]]
		"leo_home":entries=[["bed",4.5,-2.6,0],["nightstand",5.1,.1,-90],["sofa",-3.4,-2.25,0],["table",-3.4,-.6,0],["rug",-3.4,-1.1,0],["bookshelf",-5,-3.3,0],["bookshelf",-1.7,-3.3,0],["desk",-4.5,2.6,180],["chair",-4.5,1.6,0],["fridge",.2,-3.2,0],["stove",1.6,-3.2,0],["sink",2.7,-3.2,0],["dining",.5,1.5,0],["chair",.5,2.5,180],["chair",.5,.5,0],["toilet",4.1,2.6,180],["shower",5.3,2.8,0],["plant",-5.1,.8,0]]
