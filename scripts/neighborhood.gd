...
static func layout(place:String) -> Array:
	...
	match place:
		...
		"priya_home":entries=[["bed",4.4,-2.7,0],["nightstand",5.0,-1.9,90],["bookshelf",-3.0,-3.2,0],["bookshelf",-4.9,1.0,90],["bookshelf",-4.9,2.8,90],["sofa",-2.6,2.6,180],["rug",-2.6,1.7,0],["table",-2.6,.6,0],["lamp",-3.8,2.0,0],["fridge",.2,-3.2,0],["stove",1.6,-3.2,0],["sink",2.7,-3.2,0],["dining",.4,1.5,0],["chair",.4,2.5,180],["toilet",4.2,2.5,180],["shower",5.3,2.9,0],["plant",-1.0,3.6,0]]
