...
def run():
    ...
    parser.add_argument("--suite",choices=("home","neighborhood","menus","bench","creator","family","activity","lifecycle","school","school_presentation","desk","chair","grip","genealogy","grip_birthday","family_rewards","surface","autonomy_week","wait_priority","supported_homework","speech_lifetime"),default="home")
    ...
    evidence_folder={"home":"playthrough","neighborhood":"neighborhood_playthrough","menus":"menu_edges","bench":"bench_playthrough","creator":"creator_playthrough","family":"family_playthrough","activity":"activity_playthrough","lifecycle":"lifecycle_playthrough","school":"school_playthrough","school_presentation":"school_presentation","desk":"desk_clearance","chair":"shared_chair","grip":"activity_playthrough","genealogy":"genealogy_playthrough","grip_birthday":"grip_birthday","family_rewards":"family_rewards","surface":"activity_playthrough","wait_priority":"wait_priority","autonomy_week":"autonomy_week","supported_homework":"supported_homework","speech_lifetime":"speech_lifetime"}[args.suite]
